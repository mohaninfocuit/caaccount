...
def dbfetch(sql):
     print(sql)
     try:
      con = psycopg2.connect(user='jzlmmnnsrmocou',password='8c53c3d4a8e95e91589410b81e6be11d931db3dedf8ad475da6ee01b6e0a0ee8',host='ec2-174-129-209-212.compute-1.amazonaws.com',port='5432',database='de2euh8sdieq9p')
      cur = con.cursor()
